...
object WeatherRepository {
    ...
    private val allLocations = listOf(
        // 🇨🇳 中国 (13)
        WeatherLocation("北京", "bei jing", "B", 39.9042, 116.4074, "Asia/Shanghai", "中国", "CN"),
        WeatherLocation("上海", "shang hai", "S", 31.2304, 121.4737, "Asia/Shanghai", "中国", "CN"),
        WeatherLocation("广州", "guang zhou", "G", 23.1291, 113.2644, "Asia/Shanghai", "中国", "CN"),
        WeatherLocation("深圳", "shen zhen", "S", 22.5431, 114.0579, "Asia/Shanghai", "中国", "CN"),
        WeatherLocation("成都", "cheng du", "C", 30.5728, 104.0668, "Asia/Shanghai", "中国", "CN"),
        WeatherLocation("杭州", "hang zhou", "H", 30.2741, 120.1551, "Asia/Shanghai", "中国", "CN"),
        WeatherLocation("重庆", "chong qing", "C", 29.4316, 106.9123, "Asia/Shanghai", "中国", "CN"),
        WeatherLocation("武汉", "wu han", "W", 30.5928, 114.3055, "Asia/Shanghai", "中国", "CN"),
        WeatherLocation("西安", "xi an", "X", 34.3416, 108.9398, "Asia/Shanghai", "中国", "CN"),
        WeatherLocation("南京", "nan jing", "N", 32.0603, 118.7969, "Asia/Shanghai", "中国", "CN"),
        WeatherLocation("天津", "tian jin", "T", 39.3434, 117.3616, "Asia/Shanghai", "中国", "CN"),
        WeatherLocation("苏州", "su zhou", "S", 31.2989, 120.5853, "Asia/Shanghai", "中国", "CN"),
